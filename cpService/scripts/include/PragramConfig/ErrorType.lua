...
table["InsufficientPrivileges"]      = -13 --权限不足
--数据库 50 - 100 
...
table["PlayerNotJoinGame"]           = -510 --玩家乜有加入游戏
table["PlayerJoinGameEarlie"]        = -511 --玩家乜有加入游戏
table["NotStartGame"]                = -512 --没有开始游戏
table["StartGameEarlie"]             = -513 --没有开始游戏
table["TablePalyerNotEnough"]        = -514 --桌子人员不足
return table